	  		...
	  		<div class="col-lg-12">
	  			<div class="search_option">
					  ...
					  <div class="form-group">
					    <input type="text" class="form-control" id="exampleInputEmail2" placeholder="What kind of job are you looking for?">
					  </div>
				...
				<div class="job_listing">
					...
					<div class="forum_table_container">
						<table class="forum_table">
							...
							<tr>
								<td><a href="forum_single.html">Installations</a><br><span class="sub_heading"> -- This section is related to the installation</span></td>
								<td>230</td>
								<td>150</td>
							</tr>
							<tr>
								<td>Finding Job<br><span class="sub_heading"> -- This section is related to the finding jobs</span></td>
								<td>230</td>
								<td>230</td>
								
							</tr>
							<tr>
								<td>Payments<br><span class="sub_heading"> -- This section is related to the payments</span></td>
								<td>230</td>
								<td>230</td>
							...
							<tr>
								<td>Installations<br><span class="sub_heading"> -- This section is related to the installation</span></td>
								<td>230</td>
								<td>150</td>
							</tr>
							<tr>
