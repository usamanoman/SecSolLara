			...
			<div class="col-lg-12">
				{{Form::open(array('route' => array('job.update',$job->id),'method'=>'PATCH' , 'role'=>'form','class'=>'form-horizontal'))}}
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-10">
				      {{ Form::text('poc_email', $job->poc_email, ['class' => 'form-control','id'=>'poc_email','placeholder'=>'Point of contact email']) }}
				    </div>
				  </div>
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-10">
				      {{ Form::text('poc_phone', $job->poc_phone, ['class' => 'form-control','id'=>'poc_phone','placeholder'=>'Point of contact phone']) }}
				    </div>
				  </div>
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-10">
				      {{ Form::text('application_page', $job->application_page, ['class' => 'form-control','id'=>'application_page','placeholder'=>'Application page URL']) }}
				    </div>
				  </div>
